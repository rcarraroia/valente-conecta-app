      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-lg font-heading font-bold leading-tight">Coração Valente</h1>
        ...
        <Button 
          variant="ghost" 
          size="icon" 
          className="text-white hover:bg-white/20 w-10 h-10 touch-target flex-shrink-0" 
